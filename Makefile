...
USERLAND_RS_BINS := init sh cat echo true false touch mount login id su sleep ping curl_lite loopback_demo sig_demo edit ansi_demo
...
USER_LOOPBACK_DEMO_ELF := build/userland/loopback_demo.elf
...
$(USER_LOOPBACK_DEMO_ELF): $(USERLAND_RS_STAMP)
